 ...
 */
JNIEXPORT jstring JNICALL Java_com_yeecall_claheandroidtest_ndk_JniUtils_getStringFormC
...
jbyteArray Java_com_yeecall_claheandroidtest_ndk_JniUtils_getKeyValue(JNIEnv *env, jobject obj)
{
...
//JNIEXPORT JNICALL
jbyteArray Java_com_yeecall_claheandroidtest_ndk_JniUtils_getIv(JNIEnv *env, jobject obj)
{
